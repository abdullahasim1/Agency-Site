...
const iconLoaders: Record<string, () => Promise<{ default: LucideIcon }>> = {
  ...
  AlarmClock: () =>
    import("lucide-react").then((m) => ({ default: m.AlarmClock })),
  ArrowRightLeft: () =>
  ...
  ChartNoAxesCombined: () =>
    import("lucide-react").then((m) => ({ default: m.ChartNoAxesCombined })),
  ClipboardCheck: () =>
    import("lucide-react").then((m) => ({ default: m.ClipboardCheck })),
  ClipboardList: () =>
  ...
  Component: () =>
    import("lucide-react").then((m) => ({ default: m.Component })),
  ...
  DatabaseBackup: () =>
    import("lucide-react").then((m) => ({ default: m.DatabaseBackup })),
  FileClock: () =>
    import("lucide-react").then((m) => ({ default: m.FileClock })),
  FileDown: () => import("lucide-react").then((m) => ({ default: m.FileDown })),
  FileOutput: () =>
    import("lucide-react").then((m) => ({ default: m.FileOutput })),
  FileSearch: () =>
    import("lucide-react").then((m) => ({ default: m.FileSearch })),
  FileSpreadsheet: () =>
  ...
  Fingerprint: () =>
    import("lucide-react").then((m) => ({ default: m.Fingerprint })),
  FunctionSquare: () =>
    import("lucide-react").then((m) => ({ default: m.FunctionSquare })),
  Gauge: () => import("lucide-react").then((m) => ({ default: m.Gauge })),
  GitBranch: () =>
    import("lucide-react").then((m) => ({ default: m.GitBranch })),
  GitFork: () => import("lucide-react").then((m) => ({ default: m.GitFork })),
  Globe: () => import("lucide-react").then((m) => ({ default: m.Globe })),
  GraduationCap: () =>
    import("lucide-react").then((m) => ({ default: m.GraduationCap })),
  Handshake: () =>
    import("lucide-react").then((m) => ({ default: m.Handshake })),
  Headphones: () =>
    import("lucide-react").then((m) => ({ default: m.Headphones })),
  ...
  PanelsTopLeft: () =>
    import("lucide-react").then((m) => ({ default: m.PanelsTopLeft })),
  PhoneCall: () =>
  ...
  WalletCards: () =>
    import("lucide-react").then((m) => ({ default: m.WalletCards })),
  ...
  CheckCircle2: () =>
    import("lucide-react").then((m) => ({ default: m.CheckCircle2 })),
  CheckCircle: () =>
    import("lucide-react").then((m) => ({ default: m.CheckCircle2 })),
  AlertTriangle: () =>
    import("lucide-react").then((m) => ({ default: m.TriangleAlert })),
  ...
  HeartHandshake: () =>
    import("lucide-react").then((m) => ({ default: m.HeartHandshake })),
  UserCheck: () =>
