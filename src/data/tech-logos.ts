...
const techLogos: Record<string, string> = {
  ...
  "Framer Motion": "/logos/framer.svg",
  Recharts: "/logos/recharts.svg",
  Lucide: "/logos/lucide.svg",
  "lucide-react": "/logos/lucide.svg",
  ESLint: "/logos/eslint.svg",
  "next-themes": "/logos/nextjs.svg",
  ...
  "Google Certified": "/logos/google-cloud.svg",
  "Google Cloud Certified": "/logos/google-cloud.svg",
  "Google Cloud": "/logos/google-cloud.svg",
  Google: "/logos/google.svg",
  Claude: "/logos/claude.svg",
  "Claude Certified": "/logos/claude.svg",
  ...
  AWS: "/logos/aws.svg",
  "AWS Certified": "/logos/aws.svg",
  "Microsoft Azure": "/logos/azure.svg",
  Azure: "/logos/azure.svg",
  "Microsoft Certified": "/logos/azure.svg",
  ...
  DynamoDB: "/logos/aws/dynamodb.svg",
  "Anthropic Claude": "/logos/anthropic.svg",
  "Claude API": "/logos/claude.svg",
  "Claude Models": "/logos/claude.svg",
  "Next.js App Router": "/logos/nextjs.svg",
  "Next.js app router": "/logos/nextjs.svg",
  "Next.js API routes": "/logos/nextjs.svg",
  "Node.js 20.x": "/logos/nodejs.svg",
  "Vercel Serverless": "/logos/vercel.svg",
  "Vercel Serverless Functions": "/logos/vercel.svg",
  "Tailwind CSS 4": "/logos/tailwindcss.svg",
  "Tailwind CSS v4": "/logos/tailwindcss.svg",
  "Lucide React": "/logos/lucide.svg",
  "lucide-react icons": "/logos/lucide.svg",
  "Hugging Face FLUX.1": "/logos/huggingface.svg",
  "Hugging Face Inference": "/logos/huggingface.svg",
  ...
  MUI: "/logos/mui.svg",
  esbuild: "/logos/esbuild.svg",
  Leaflet: "/logos/leaflet.svg",
  Formik: "/logos/formik.svg",
  Yup: "/logos/yup.png",
  JavaScript: "/logos/js.svg",
  "Vanilla JavaScript": "/logos/js.svg",
  HTML: "/logos/html5.svg",
  HTML5: "/logos/html5.svg",
  "HTML5 Canvas": "/logos/html5.svg",
  "HTML5 Canvas 2D": "/logos/html5.svg",
  CSS: "/logos/css.svg",
  CSS3: "/logos/css.svg",
  "Neon PostgreSQL": "/logos/neon.png",
  Nodemailer: "/logos/nodemailer.png",
  SerpAPI: "/logos/serpapi.png",
  MediaStack: "/logos/mediastack.png",
  "NewsData.io": "/logos/newsdataio.png",
  ...
  Threads: "/logos/threads.svg",
  X: "/logos/x.svg",
  "Amazon Web Services": "/logos/aws.svg",
  "API Gateway": "/logos/aws/api-gateway.svg",
  "Claude (Anthropic)": "/logos/claude.svg",
  RAG: "/logos/rag.png",
  Pinecone: "/logos/pinecone.png",
  "Pinecone Vector Database": "/logos/pinecone.png",
  Motion: "/logos/motion.png",
  "Canvas Confetti": "/logos/canvas-confetti.png",
  TSX: "/logos/tsx.png",
  SVG: "/logos/svg.svg",
  Voiceflow: "/logos/voiceflow.png",
  "Voiceflow conversation design": "/logos/voiceflow-conversation-design.png",
  "Axios client": "/logos/axios.svg",
  Prisma: "/logos/prisma.svg",
  "Retell AI": "/logos/retell-ai.png",
  "Prisma ORM": "/logos/prisma.svg",
  "Redux Toolkit": "/logos/redux.svg",
  "React Router": "/logos/reactrouter.svg",
  "Retell AI chat agents": "/logos/retell-ai-chat-agents.png",
  "Calendly REST API sync": "/logos/calendly.svg",
  "Sentiment Analysis": "/logos/sentiment-analysis.png",
  "Generative AI": "/logos/generative-ai.png",
  GPT: "/logos/gpt.png",
  Llama: "/logos/meta.svg",
  Blotato: "/logos/blotato.png",
  "Companies House": "/logos/companies-house.png",
  OpenSanctions: "/logos/opensanctions.png",
  Gmail: "/logos/gmail.svg",
  JSON: "/logos/json.svg",
  Webhooks: "/logos/webhooks.png",
};
