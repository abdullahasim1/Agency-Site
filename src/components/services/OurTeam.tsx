  ...
  return (
    ...
    >
      ...
      <div
        aria-hidden
        className={cn(
          "pointer-events-none absolute -left-40 top-0 size-[30rem] rounded-full blur-[80px]",
      ...
      <div
        aria-hidden
        className={cn(
          "pointer-events-none absolute -right-40 bottom-0 size-[28rem] rounded-full blur-[80px]",
